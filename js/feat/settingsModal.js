...
const SettingsModal = {
	...
	init() {
		...
		<div class=btr-settings-modal>
			<div class=btr-settings>
				...
				<div class=btr-settings-footer>
					<div class=btr-settings-footer-version>v${chrome.runtime.getManifest().version} - BG Music's Fork</div>
					<a href=https://www.roblox.com/users/799109733/profile target=_blank title="Check me out on Roblox" class=btr-settings-footer-roblox></a>
		...
		if(!IS_DEV_MODE) {
			for(const elem of this.settingsDiv.$findAll("[devOnlyyy]")) {
				elem.remove()
			}
		}
